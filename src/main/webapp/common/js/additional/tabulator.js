...
;(function (global, factory) {
	...
	Column.prototype.defaultOptionList.push('data_type', 'valid_types', 'valid_min', 'valid_format');// 2021.01.15, added option for validation
	//////////////// Event Bindings /////////////////
	...
	Edit.prototype.editors = {
		...
		input: function input(cell, onRendered, success, cancel, editorParams) {
			...
			// input.addEventListener("keydown", onKeyUpDown);
			// input.addEventListener("keyUp", onKeyUpDown);
		...
		autocomplete: function autocomplete(cell, onRendered, success, cancel, editorParams) {
			...
			function filterList(term, intialLoad) {
				...
				if (editorParams.searchFunc) {
					...
					if (matches instanceof Promise) {
						...
						add2NotiStoragece(typeof editorParams.searchingPlaceholder !== "undefined" ? editorParams.searchingPlaceholder : "Searching...");
			...
			function add2NotiStoragece(notice) {
			...
			function fillListIfNotEmpty(items, intialLoad) {
				if (items.length) {
					...
					if (editorParams.emptyPlaceholder) {
						add2NotiStoragece(editorParams.emptyPlaceholder);
					}
				}
			}
	...
	MoveRows.prototype.startMove = function (e, row) {
		...
		//console.log("tabulator.js(20486) startY =>" + row.getHeight());
