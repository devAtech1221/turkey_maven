...
public @Getter @Setter class Customer extends BeanCommon /* implements BeanInterface */{
//	private String SEQ;
	...
	public Customer() {}
	public Customer(HttpServletRequest request, String setName){super(request, setName);}
}
