...
public @Getter @Setter class Purchase extends BeanCommon /* implements BeanInterface */{
//	private String SEQ;
	...
	public Purchase() {}
	public Purchase(HttpServletRequest request, String setName){super(request, setName);}
}
